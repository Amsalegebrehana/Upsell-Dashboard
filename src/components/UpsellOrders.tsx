  ...
  const orders: UpsellOrder[] = [
    {
      ...
      endDate: "Dec 19, 2023",
      product: "Pool Heating",
      quantity: "Upsell Value",
      customer: "Aaron Marshal",
      location: "#1 Rated Mansion",
      price: 100,
    },
    {
      id: 2,
    ...
    <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      <div className="max-w-full overflow-x-auto">
        <table className="w-full table-auto text-sm overflow-hidden">
          ...
          <tbody>
            {orders.map((order) => (
              <tr key={order.id} className="border-b border-[#eee] dark:border-strokedark">
                <td className="py-5 px-4 pl-9 dark:border-strokedark xl:pl-7">
                  {order.id}
                </td>
