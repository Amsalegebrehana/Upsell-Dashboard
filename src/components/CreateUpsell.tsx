...
import {Typography} from "@material-tailwind/react";
  ...
  export function CreateUpsell() {
    ...
    const handleShowSettings = (value: boolean) => {
            ...
            <div className="flex flex-wrap">
              <div style={{flex:1}} className="hidden w-full mt-40 xl:block xl:w-1/2">
                <div className="py-17.5 px-26 text-center">
                    <button className="bg-transparent border rounded-full w-30 h-8 uppercase">
                        <h1 className="mb-5.5 text-xl font-bold">Preview</h1>
                    </button>
                  <span className="mt-5 ml-10 inline-block">
                    <svg
                      width="350"
                      height="350"
                      viewBox="0 0 350 350"
              ...
              <div style={{flex:2}} className="flex flex-col gap-6 ml-30 mt-22 mr-55">
                    <div className="flex w-full gap-6">
                        <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-60 h-30 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p style={{fontSize:"9px"}} className="text-gray-500 dark:text-gray-400">SVG, PNG, JPG or GIF (MAX. 800x400px)</p>
                            </div>
                    ...
                    <div>
                        ...
                        <input
                        placeholder=""
                        className="w-full border mt-2 pl-2 h-10 bg-transparent rounded"
                        />
                    </div>
                    <div className="mt-3">
                        <Typography variant="h6" color="blue-gray" className="font-bold text-black">
                        ...
                        <input
                        className="w-full border mt-2 pl-2 h-30 bg-transparent rounded"
                        />
                    </div>
                    <div className="mt-3">
                        ...
                        <select className="w-full h-10 border-t-blue-gray-200 focus:border-t-gray-900 bg-transparent border rounded" style={{ marginBottom: "20px", marginTop:"20px" }}>
                            <option value="option1">Standard Pricing</option>
                    ...
                    <div className="flex gap-2" style={{ marginBottom: "20px" }}>
                        ...
                        <select className="w-full h-7 border-t-blue-gray-200 mt-4 bg-transparent border rounded">
                            <option value="per1">Booking</option>
                            <option value="per2">Per 2</option>
                            <option value="per3">Per 3</option>
                        </select>
                        </div>
                        <div style={{ flex: 1 }}>
                        <Typography variant="h6" color="blue-gray" className="-mb-3 font-bold text-black">
                        ...
                        <select className="w-full h-7 border-t-blue-gray-200 mt-4 bg-transparent border rounded">
                            <option value="period1">One Time</option>
                    ...
                    <div>
                        <button onClick={() => handleShowSettings(!showSettings)} className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-gray-800 py-1 mr-3">
